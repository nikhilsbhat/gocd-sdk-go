...
type GoCd interface {
	...
	GetClusterProfiles() ([]CommonConfig, error)
	...
	DeleteClusterProfile(name string) ([]CommonConfig, error)
	GetAgentProfiles() ([]CommonConfig, error)
	GetAgentProfile(name string) ([]CommonConfig, error)
	CreateAgentProfile(config CommonConfig) ([]CommonConfig, error)
	UpdateAgentProfile(config CommonConfig) ([]CommonConfig, error)
	DeleteAgentProfile(name string) ([]CommonConfig, error)
